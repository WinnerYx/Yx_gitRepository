    ...
    <div class="layuimini-main width_60">
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="teacherId" lay-filter="teacherId" lay-verify="required">
                        <option value="">请选择</option>
                        <c:forEach items="${teachers}" var="teacher">
                            <option value="${teacher.id}"<c:if test="${teacher.id == teacher.id}">selected</c:if>>${teacher.teacherName}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="stuPwd" value="${student.stuPwd}" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">

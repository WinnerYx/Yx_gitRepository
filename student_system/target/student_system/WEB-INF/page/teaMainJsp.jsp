            ...
            <div class="layui-col-md8">
                <div class="layui-row layui-col-space15">
                                ...
                                <div class="welcome-module">
                                    <div class="layui-row layui-col-space10 layuimini-qiuck">
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="javascript:;" layuimini-content-href="student/teacher_student" data-title="学生档案管理" data-icon="fa fa-window-maximize">
                                                <i class="fa fa-window-maximize"></i>
                                                <cite>学生档案</cite>
                                            </a>
                                        </div>
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="javascript:;" layuimini-content-href="workStatus/studentWorkStatus" data-title="学生就业信息管理" data-icon="fa fa-gears">
                                                <i class="fa fa-gears"></i>
                                                <cite>学生就业信息</cite>
                                            </a>
                                        </div>
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="javascript:;" layuimini-content-href="request/audit" data-title="审批管理" data-icon="fa fa-file-text">
                                                <i class="fa fa-file-text"></i>
                                                <cite>审批</cite>
                                            </a>
                                        </div>
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="javascript:;" layuimini-content-href="job/list" data-title="勤工岗位管理" data-icon="fa fa-dot-circle-o">
                                                <i class="fa fa-dot-circle-o"></i>
                                                <cite>勤工岗位</cite>
                                            </a>
                                        </div>
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="javascript:;" layuimini-content-href="announcement/list" data-title="公告信息发布" data-icon="fa fa-calendar">
                    ...
                    <div class="layui-col-md12">
                        <div class="layui-card">
                            <div class="layui-card-header"><i class="fa fa-line-chart icon"></i>班级学生情况统计</div>
                            <div class="layui-card-body">
        ...
        $.ajax({
            ...
            success:function(data){
                if(data.code=="1000"){
                    echartsRecords.setOption({
                        xAxis: {
                            data: data.data.clazzName
                        },
                        series: [
                            {
                                name:'贫困生',
                                type:'line',
                                data:data.data.studentPoorCounts
                            },
                            {
                                name:'已就业学生',
                                type:'line',
                                data:data.data.studentWorkCounts
                            }
                        ]
                    });
                }

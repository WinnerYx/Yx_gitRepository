        ...
        <form class="layui-form">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="company" lay-verify="required" class="layui-input">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="workTime"  autocomplete="off" value='<fmt:formatDate value="${workStatus.workTime}" pattern="yyyy-MM-dd"/>' lay-verify="date"  placeholder="yyyy-MM-dd" id="workTime" class="layui-input">
                </div>
            </div>
...
<script>
    layui.use(['layer','laydate','upload','form','jquery','laydate'], function () {
        ...
        form.on('submit(save)', function (data) {
            ...
            $.ajax({
                url:"${basePath}workStatus/create",
                type:"POST",
                dataType:'json',
                data:data.field,

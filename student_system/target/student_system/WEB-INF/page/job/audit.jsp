    ...
    layui.use(['form', 'table'], function () {
        ...
        table.on('toolbar(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'agree') {   // 监听添加操作
                ...
                layer.confirm('确认同意该学生的勤工岗位申请吗？', function (index) {

                    $.ajax({
                        url:"${basePath}job/audit_agree",
                        type:"POST",
                        dataType:'json',
                        data:"ids="+arr.join(","),
                ...
                layer.confirm('确认拒绝该学生的勤工岗位申请吗？', function (index) {

                    $.ajax({
                        url:"${basePath}job/refuse",
                        type:"POST",
                        dataType:'json',
                        data:"ids="+arr.join(","),
                        success:function(data){

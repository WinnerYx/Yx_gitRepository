                                        ...
                                        <div class="layui-col-xs6">
                                            <div class="panel layui-bg-number">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="panel-content">
                                                        <h1 class="number" id="announcementCount"></h1>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="welcome-module">
                                    <div class="layui-row layui-col-space10 layuimini-qiuck">
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="javascript:;" layuimini-content-href="teacher/list" data-title="教师账号管理" data-icon="fa fa-window-maximize">
                                                <i class="fa fa-window-maximize"></i>
                                                <cite>教师账号管理</cite>
                                            </a>
                                        </div>
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="javascript:;" layuimini-content-href="student/user_student" data-title="学生账号管理" data-icon="fa fa-gears">
                                                <i class="fa fa-gears"></i>
                                                <cite>学生账号管理</cite>
                                            </a>
                                        </div>
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="javascript:;" layuimini-content-href="power/list" data-title="用户权限管理" data-icon="fa fa-file-text">
                                        ...
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="javascript:;" layuimini-content-href="request/user_studentRequest_list" data-title="学生请假管理" data-icon="fa fa-file-text">
                                                <i class="fa fa-file-text"></i>
                                                <cite>学生请假管理</cite>
                                            </a>
                                        </div>
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="javascript:;" layuimini-content-href="user/list" data-title="用户类型管理" data-icon="fa fa-dot-circle-o">
                                                <i class="fa fa-dot-circle-o"></i>
                                                <cite>用户类型管理</cite>
                                            </a>
                                        </div>
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="javascript:;" layuimini-content-href="announcement/user_list" data-title="公告管理" data-icon="fa fa-calendar">
    ...
    layui.use(['echarts','jquery'], function () {
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $('#announcementCount').html(''+data.data.announcementCount);

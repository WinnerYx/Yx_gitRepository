...
<div class="layuimini-container layuimini-page-anim">
    <div class="layuimini-main width_60">
        <form class="layui-form">
            <input type="hidden" value="${studyStatus.id}" name="id" id="id">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="reason" lay-verify="required" value="${studyStatus.reason}" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">时间</label>
                <div class="layui-input-block">
                    <input type="text" name="days" lay-verify="required" value="${studyStatus.days}" class="layui-input">
                </div>
            </div>
...
<script>
    layui.use(['form','jquery'], function () {
        ...
        $.ajax({
            url:"${basePath}study/update_queryById",
            type:"POST",
            data:"id="+id,

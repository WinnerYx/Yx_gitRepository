        ...
        <div class="layui-form login-form">
            <form class="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" name="userName" lay-verify="required" placeholder="请输入用户名" autocomplete="off" class="layui-input" value="">
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    <label class="layui-icon layui-icon-triangle-d"></label>
                ...
                <div class="layui-form-item">
                        ...
                        <input type="text" name="captcha" style="width: 200px;" lay-verify="required" placeholder="验证码" autocomplete="off" class="layui-input verification captcha">
                ...
                <%--<div class="layui-form-item">
                    <label class="layui-icon layui-icon-vercode"></label>
                    <input type="text" name="captcha" style="width: 150px; lay-verify="required" placeholder="验证码" autocomplete="off" class="layui-input verification captcha" value="">
                    <div class="captcha-img">
                        <img id="captchaPic" src="${basePath}captcha/code" id="captchaImg">
                    </div>
                </div>--%>
                <div class="layui-form-item">

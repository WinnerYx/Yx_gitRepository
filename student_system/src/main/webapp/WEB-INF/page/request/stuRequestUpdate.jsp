        ...
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="reason" lay-verify="required" value="${request.reason}" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">请假时间</label>
                <div class="layui-input-block">
                    <input type="text" name="days" lay-verify="required" value="${request.days}" class="layui-input">
                </div>
            </div>
...
<script>
    layui.use(['form','jquery'], function () {
        ...
        $.ajax({
            url:"${basePath}request/update_queryById",
            type:"POST",
            data:"id="+id,
        ...
        form.on('submit(save)', function (data) {
            $.ajax({
                url:"${basePath}request/stuUpdate",
                type:"POST",

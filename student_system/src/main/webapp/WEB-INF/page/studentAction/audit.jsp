...
<script>
    layui.use(['form', 'table'], function () {
        var $ = layui.jquery,
            ...
            table.render({
                elem: '#currentTableId',
                url: '${basePath}studentAction/audit',
        ...
        table.on('toolbar(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'agree') {   // 监听添加操作
                ...
                layer.confirm('确认同意该学生的学生活动吗？', function (index) {

                    $.ajax({
                        url:"${basePath}studentAction/audit_agree",
                        type:"POST",
                        dataType:'json',
                        data:"ids="+arr.join(","),
                ...
                layer.confirm('确认拒绝该学生的学生活动申请吗？', function (index) {

                    $.ajax({
                        url:"${basePath}studentAction/refuse",
                        type:"POST",
                        dataType:'json',
                        data:"ids="+arr.join(","),
                        success:function(data){
